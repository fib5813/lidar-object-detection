...
std::unordered_set<int> Ransac::RansacLine(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud, 
...
std::unordered_set<int> Ransac::RansacPlane(pcl::PointCloud<pcl::PointXYZI>::Ptr cloud){

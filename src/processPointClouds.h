...
public:
    ...
    std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> SegmentPlane(typename pcl::PointCloud<PointT>::Ptr cloud, int maxIterations, double distanceThreshold);
    ...
    void clusterHelper(int i, const std::vector<std::vector<float> >& points, std::vector<int>& cluster, 
